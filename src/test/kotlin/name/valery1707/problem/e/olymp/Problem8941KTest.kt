...
internal class Problem8941KTest {
    @ParameterizedTest
    @ImplementationSource(
        implementation = [Problem8941K.Implementation::class],
        csv = [CsvSource(
            "2 3,1 2 3|4 5 6",
        )]
    )
    internal fun test1(variant: Implementation<Problem8941K>, input: String, expected: String) {
