...
internal class Problem1KTest {
    @ParameterizedTest
    @ImplementationSource(
        implementation = [Problem1K.Implementation::class],
        csv = [CsvSource(
            "17,1 7",
        )],
    )
    internal fun test1(variant: Implementation<Problem1K>, input: String, expected: String) {
